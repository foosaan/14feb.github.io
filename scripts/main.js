(function (window) {
  ...
  let texts = [
    "hallo ayy",
    "maaf ya",
    "blom bisa ngasih apa2",
    "oh iya ay..",
    "makasih ya",
    "kamu udh mau",
    "nemenin hari-hari aku",
    "jgn pernah brubah ya",
    "jadi spiderman",
  ...
  function draw() {
    ...
    // Menghitung skala teks agar sesuai dengan lebar canvas
    let scale = Math.min(1, CANVASWIDTH / textWidth);

    // Tentukan posisi tengah teks
    let textX = (CANVASWIDTH - textWidth * scale) / 2;
    let textY = CANVASHEIGHT / 2;

    // Terapkan transformasi skala agar teks sesuai
    ctx.save();
